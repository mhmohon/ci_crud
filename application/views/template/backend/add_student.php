...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="<?= base_url('save-student') ?>" method="POST">
                <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="span6 typeahead" id="typeahead" name="student_phone">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="typeahead">Student Roll </label>
                    <div class="controls">
                        <input type="number" class="span6 typeahead" id="typeahead" name="student_roll">
                    </div>
                </div>
