			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="<?= base_url() ?>"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>	
						<li><a href="<?= base_url('add-student') ?>"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Add Student</span></a></li>	
						<li><a href="<?= base_url('manage-student') ?>"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Manage Student</span></a></li>	
						<li><a href="<?= base_url('add/student') ?>"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Admin</span></a></li>	
